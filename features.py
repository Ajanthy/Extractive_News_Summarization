...
def title_score(mylineslower):
    ...
    print("1. Title Tokens: ", len(tiscore))
    return tiscore
...
def sent_length_score(mylineslower):
    ...
    print("2. LengthTokens: ", len(lenscore))
    return lenscore
...
def uppercase_availability(mylines):
    ...
    print("4. Uppercase score : ", len(scores))
    return scores
...
def properNounScores(tagged):
    ...
    print("6. Proper noun: ", len(scores))
    return scores
...
def centroidSimilarity(sentences, tfIsfScore):
    ...
    for sentence in sentences:
        ...
        scores.append(score)
    print("7. centroid similarity: ", len(scores))
    return scores
...
def numericToken(tokenized_sentences):
    ...
    print("8. numeric token: ", len(scores))
    return scores
